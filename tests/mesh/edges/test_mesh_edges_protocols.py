...
def test_edges_with_edged_curve(
    ...
    dataset_factory(id="123456789", viewable_file="edged_curve.vtp", viewer_elements_type="edges")
...
def test_edges_vertex_attribute(
    ...
    mesh_id = "123456789"
    dataset_factory(id=mesh_id, viewable_file="attributed_edged_curve.vtp", viewer_elements_type="edges")
