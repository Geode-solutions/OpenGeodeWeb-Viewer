...
def test_polygons_polygon_attribute(
    ...
    dataset_factory(id="123456789", viewable_file="triangulated_surface2d.vtp", viewer_elements_type="polygons")
...
def test_polygons_polygon_color_map(
    ...
    mesh_id = "123456789"
    dataset_factory(id=mesh_id, viewable_file="triangulated_surface2d.vtp", viewer_elements_type="polygons")
