...
def test_mesh_scalar_range_coordinated_lut(
    ...
    save_image(server, "coord_lut_2_attribute.jpeg")
    ...
    save_image(server, "coord_lut_4_lut_0_1_saturated.jpeg")

    # 5. Modify scalar range to [0, 500] AND MANUALLY update the LUT
    server.call(
        VtkMeshCellsView.mesh_cells_prefix
        + VtkMeshCellsView.mesh_cells_schemas_dict["vertex_scalar_range"]["rpc"],
