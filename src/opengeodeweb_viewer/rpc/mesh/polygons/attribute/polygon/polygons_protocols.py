...
class VtkMeshPolygonsView(VtkMeshView):
    ...
    @exportRpc(mesh_polygons_prefix + mesh_polygons_schemas_dict["name"]["rpc"])
    ...
    @exportRpc(mesh_polygons_prefix + mesh_polygons_schemas_dict["scalar_range"]["rpc"])
    ...
    @exportRpc(mesh_polygons_prefix + mesh_polygons_schemas_dict["color_map"]["rpc"])
