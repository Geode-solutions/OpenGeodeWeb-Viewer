...
class VtkModelSurfacesEdgesView(VtkModelView):
    ...
    @exportRpc(
        model_surfaces_edges_prefix
        + model_surfaces_edges_schemas_dict["visibility"]["rpc"]
    )
    def setModelSurfacesEdgesVisibility(self, rpc_params: RpcParams) -> None:
        validate_schema(
            rpc_params,
            self.model_surfaces_edges_schemas_dict["visibility"],
            self.model_surfaces_edges_prefix,
        )
        params = schemas.Visibility.from_dict(rpc_params)
        self.SetEdgesVisibility(params.id, params.visibility)

    @exportRpc(
        model_surfaces_edges_prefix + model_surfaces_edges_schemas_dict["color"]["rpc"]
    )
    def setModelSurfacesEdgesColor(self, rpc_params: RpcParams) -> None:
        validate_schema(
            rpc_params,
            self.model_surfaces_edges_schemas_dict["color"],
            self.model_surfaces_edges_prefix,
        )
    ...
    @exportRpc(
        model_surfaces_edges_prefix + model_surfaces_edges_schemas_dict["width"]["rpc"]
    )
    def setModelSurfacesEdgesWidth(self, rpc_params: RpcParams) -> None:
        validate_schema(
            rpc_params,
            self.model_surfaces_edges_schemas_dict["width"],
            self.model_surfaces_edges_prefix,
        )
