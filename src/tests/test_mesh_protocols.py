...
#     server.call(VtkMeshView.mesh_prefix + VtkMeshView.mesh_schemas_dict["set_edge_visibility"]["rpc"], [{"id": "123456789", "visibility": True}])
...
#     server.call(VtkMeshView.mesh_prefix + VtkMeshView.mesh_schemas_dict["set_point_visibility"]["rpc"], [{"id": "123456789", "visibility": True}])
...
#     assert server.compare_image(3, "mesh/set_point_size_1.jpeg") == True
    ...
    # server.call(VtkMeshView.mesh_prefix + VtkMeshView.mesh_schemas_dict["set_point_size"]["rpc"], [{"id": "123456789", "size": 10}])
...
def test_set_color(server):
    ...
    server.call(VtkMeshView.mesh_prefix + VtkMeshView.mesh_schemas_dict["color"]["rpc"], [{"id": "123456789", "red": 50, "green": 2, "blue": 250}])
