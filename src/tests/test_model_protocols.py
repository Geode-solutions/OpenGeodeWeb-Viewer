...
def test_register_model(server):
    ...
    server.call(class_.prefix + class_.schemas_dict["register"]["rpc"], [{"id": "123456789", "file_name": "CrossSection.vtm"}])
...
def test_set_mesh_visibility(server):
    ...
    server.call(class_.prefix + class_.schemas_dict["set_mesh_visibility"]["rpc"], [{"id": "123456789", "visibility": True}])
...
def test_set_components_visibility(server):
    ...
    server.call(class_.prefix + class_.schemas_dict["set_components_visibility"]["rpc"], [{"id": "123456789", "visibility": False}])
...
def test_set_components_color(server):
    ...
    server.call(class_.prefix + class_.schemas_dict["set_components_color"]["rpc"], [{"id": "123456789", "red": 255, "green": 0, "blue": 0}])
